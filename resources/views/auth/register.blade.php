                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <label for="status" class="col-form-label text-md-right">{{ __('Marital Status') }}</label>
                                <select name="status" id="status"  class="form-control @error('status') is-invalid @enderror" value="{{ old('status') }}" required autocomplete="status">
                        ...
                        <div class="form-group row">
                            <div class="col-md-4">
                                ...
                                <textarea name="address" id="address" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name"></textarea>
                                @error('address')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-md-4">
                                <label for="cellphone_no" class="col-form-label text-md-right">{{ __('Cellphone Number') }}</label>
                                <input id="cellphone_no" type="tel" maxlength="11" class="form-control @error('age') is-invalid @enderror" name="cellphone_no" value="{{ old('age') }}" required autocomplete="cellphone_no">
                            ...
                            <div class="col-md-4">
                                <label for="salary" class="col-form-label text-md-right">{{ __('Expected Salary') }}</label>
                                <input id="salary" type="number" class="form-control @error('age') is-invalid @enderror" name="salary" value="{{ old('salary') }}" required autocomplete="salary">
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                <label for="objectives" class="col-form-label text-md-right">{{ __('Long term objectives') }}</label>
                                <textarea name="objectives" id="objectives" class="form-control @error('objectives') is-invalid @enderror" value="{{ old('objectives') }}" required autocomplete="objectives"></textarea>
                                @error('objectives')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                <label for="background" class="col-form-label text-md-right">{{ __('Acceptance of Request to do full background check') }}</label>
                                <textarea name="background" id="background" class="form-control @error('background') is-invalid @enderror"  value="{{ old('background') }}" required autocomplete="background"></textarea>
                                @error('background')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="cv" type="file" class="form-control @error('cv') is-invalid @enderror" name="cv" value="{{ old('cv') }}" required autocomplete="cv" accept="application/pdf">
                        ...
                        <div class="form-group row">
                            <div class="col-md-6">
                                <label for="audio" class="col-form-label text-md-right">{{ __('Introduce Yourself') }} </label> <small class="text-muted text-primary">(attach short recording about yourself)</small>
                                <input id="audio" type="file" class="form-control @error('audio') is-invalid @enderror" name="audio" value="{{ old('audio') }}" required autocomplete="audio">
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                <label for="office_desc" class="col-form-label text-md-right">{{ __('Describe what your office like') }}</label>
                                <textarea name="office_desc" id="office_desc" class="form-control @error('office_desc') is-invalid @enderror" value="{{ old('office_desc') }}" required autocomplete="office_desc"></textarea>
                                @error('objectives')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            <div class="col-md-6">
                                <label for="office" class="col-form-label text-md-right">{{ __('Photo of your office') }}</label>
                                <input id="office" type="file" class="form-control @error('office') is-invalid @enderror" name="office" value="{{ old('office') }}" required autocomplete="office">
                            ...
                            <div class="col-md-6">
                                <label for="internet" class="col-form-label text-md-right">{{ __('Internet Connection') }}</label>
                                <small class="text-muted text-primary">(attach screen shot of speed test)</small>
                                <input id="internet" type="file" class="form-control @error('internet') is-invalid @enderror" name="internet" value="{{ old('internet') }}" required autocomplete="internet">
