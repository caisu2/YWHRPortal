                                    ...
                                    <div class="user-avatar-address">
                                        <p class="border-bottom pb-3">
                                            <span class="d-xl-inline-block d-block mb-2"><i
                                                    class="fa fa-map-marker-alt mr-2 text-primary "></i>4045 Denver AvenueLos Angeles, CA 90017</span>
                ...
                <div class="card campaign-card text-center">
                    <div class="card-body">
                        ...
                        <div class="campaign-info">
                            ...
                            <a href="#"><i class="fab fa-twitter-square fa-sm twitter-color"></i> </a><a
                ...
                <div class="card campaign-card text-center">
                    <div class="card-body">
                        ...
                        <div class="campaign-info">
                            ...
                            <a href="#"><i class="fab fa-instagram fa-sm instagram-color"></i> </a><a
                                href="#"><i class="fab fa-facebook-square fa-sm facebook-color"></i></a>
                        </div>
                    </div>
                </div>
            </div>
